...
try{
 ...
 console.log('PASS 3 hub-to-detail journeys, all 6 detail CTAs and 3 hub register actions preselect correct date; 4 widths each, 6 axe checks, no-JS abstracts, 6 screenshots; 0 external requests, 0 submissions, 0 browser errors.');
